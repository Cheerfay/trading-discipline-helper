...
> 最后更新：2026-06-20（对应分支 `xiaomi-blue-ui-experiment` 的状态）。
...
5. **品牌 icon**：正式采用「盾牌 + 检查」方案，表达纪律、风控和保护，不暗示涨跌方向；已接入 `public/favicon.svg` 与 `public/logo.svg`。
...
| `xiaomi-blue-ui-experiment` | 当前工作分支：蓝色克制版 UI、品牌 icon、首页/结果页/历史页视觉统一 |
